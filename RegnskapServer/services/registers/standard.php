...
$ib_post = array_key_exists("ib_post", $_REQUEST) ? $_REQUEST["ib_post"] : "0";
...
switch ($action) {
    case "get" :
        ...
        $res["ib_post"] = $accStd->getOneValue(AccountStandard::CONST_IB_POST);
    ...
    case "save" :
        ...
        $res = $res | $accStd->setValue(AccountStandard::CONST_IB_POST, $ib_post);
        $report = array();
