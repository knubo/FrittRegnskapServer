...
class AccountPostType {
    ...
    function AccountPostType($db, $a = 0, $b = 0, $c = 0, $d = 0, $f = 0, $isEarning = 0, $isCost = 0, $isCapital = 0, $isOwning = 0, $isDeprecation = 0) {
        $this->db = $db;
        $this->PostType = & $a;
        $this->CollPost = & $b;
        $this->Description = & $c;
        ...
        $this->Owning = $isOwning;
        $this->Deprecation = $isDeprecation;
    }
