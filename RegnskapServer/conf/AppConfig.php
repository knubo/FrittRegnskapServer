...
const CountValues= array(1000,500,200,100,50,20,10,5,1,0.5);
     
#Columns in database for count
const CountColumns= array('a1000','a500','a200','a100','a50','a20','a10','a5','a1','a_5');
	
#Posts possible to register a count.
const CountPosts=array(9010,9020);
#Posts possible to move between in move/count sheme.
const MovePosts=array(1904,1905);
#Fordring posts
const FordringPosts=array(1370,1380,1390,1500,1570);
#Posts that are to be transfered to next month.
const EndPosts=array(1904,1905,1920);
...
const RegisterMembershipPosts=array(1920,1904,1905,9201,9202,9203,9204,9205,9206,9207,9208,9209,9210,9211,9212,9213,9214,9215,9216,9217,9218);
...
#
const DivPosts=array(3999,7990,8400,8500,1370,1380,1390);
}
